    ...
    methods: {
      ...
      addAndEdit() {
        ...
        !this.apparat_Error) {
          ...
          if (this.DialogType) {
              SkillService.create_Skill_Direction({data}).then(
              (res) => {
            ...
            SkillService.update_Skill_Direction({ direction_id: this.direction_id , data }).then(
              (res) => {
                this.get_skill_Types(this.params, false);
                this.$toast.add({
                  severity: "success",
      ...
      deleteItem(id) {
        console.log(id);
        SkillService.delete_Skill_Direction({ direction_id: id }).then((res) => {
            this.get_skill_Types(this.params, false);
          this.$toast.add({
              severity: "success",
              summary: "Muvofaqqiyatli bajarildi",
