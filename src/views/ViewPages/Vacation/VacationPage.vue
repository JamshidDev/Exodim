          ...
          <div class="col-12 pb-0">
            <bread-crumb
              :breadCump="[
                ...
                { name: 'Ta\'tillar', path: '/admin/view/vacation' },
              ]"
            ></bread-crumb>
          </div>
    ...
    methods:{
      get_List(params){
        this.controlLoaser(true)
          ViewService.get_ViewVacationCadry(params).then((res)=>{
      ...
      changeVacationType(){
        if(this.params.status_decret !== 1 ){
          this.params.status_decret = 1;
          this.btn_text= "Mehnat ta'tili"

          this.get_List(this.params)
        }else{
          this.btn_text= "Bola parvarish ta'tili"
          this.params.status_decret = 0;
          this.get_List(this.params)
        }
      },
      searchBtn(){
