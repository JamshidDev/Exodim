      ...
      <template #header>
        <div class="flex justify-content-between w-full">
           <span class="p-input-icon-left">
            ...
            <InputText type="text" v-model="searchValue" placeholder="Qidiruv" />
        </span>
        </div>
      </template>

    
      <Column field="positionName" header="Lavozim nomi" style="min-width: 16rem">
        <template #body="slotProps">
         <div class="flex font-medium">{{slotProps.data.positionName}}</div>
         </template>
      </Column>

      <Column field="positionCategory" header="Kategoriya" style="min-width: 4rem">
      
        <template #body="slotProps">
         <div class="flex font-medium">{{slotProps.data.positionCategory}}</div>
         </template>
      </Column>
      <Column field="positionCount" header="Soni" style="min-width: 4rem">
       <template #body="slotProps">
         <div class="flex font-medium">{{slotProps.data.positionCount}}</div>
         </template>
        
      </Column>
       <Column field="positionFakt" header="Soni(Fakt)" style="min-width: 4rem">
          <template #body="slotProps">
         <div class="flex font-medium">{{slotProps.data.positionFakt}}</div>
         </template>
      </Column>
        <Column field="positionFakt" header="Vakant/Sverx" style="min-width: 6rem">
         <template #body="slotProps">
         <div class="flex font-medium">0/0 <span v-show="false">{{slotProps}}}</span></div>
         </template>
      </Column>
