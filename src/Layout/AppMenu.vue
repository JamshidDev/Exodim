      ...
      item: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: "pi pi-building",
              visible: () =>
                this.get_adminPermissions("management_organizations"),
              to: "/admin/employees",
            },
          ],
        },
          ...
          items: [
            {
              ...
              visible: () =>
                this.get_adminPermissions("organization_statistics"),
            },
            {
              label: "Xodimlar",
              icon: "pi pi-users",
            ...
            },
            {
              ...
              visible: () =>
                this.get_adminPermissions("organization_departments"),
            },
            {
