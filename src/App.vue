<template>
  ...
  <div>
    <Dialog  v-model:visible="server_Error"  :breakpoints="{
          '1960px': '30vw',
          '1600px': '40vw',
          '1200px': '70vw',
          '960px': '80vw',
      ...
      <template #header>
        <h6 class="w-full text-center text-2xl text-red-500 uppercase">Texnik xatolik</h6>
      </template>
            <p class="text-2xl font-normat text-red-400 text-center">{{ errorMessage.message}}</p>
            <p class="text-500 text-base text-center font-medium"> Siz bu kutilmagan xatolikni EXODIM ma'sullari guruhiga yuborishingizni so'raymiz!</p>
            <template #footer>
              <div class="grid">
                <div class="col-12 flex justify-content-center">
                  <Button label="Yopish" icon="pi pi-times" class="p-button-sm p-button-danger" @click="server_Error=false"  />
                </div>
              </div>
