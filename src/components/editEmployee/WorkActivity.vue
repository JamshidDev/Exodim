...
export default {
  ...
  methods:{
    get_CadryCareers(id, loader){
      ...
      employeeCarreer.get_CadryCareers({id}).then((res)=>{
    ...
    addingAndEdit(){
      ...
      if(this.careerDialogType){
        employeeCarreer.create_CadryCareers({id,data}).then((res)=>{
          this.get_CadryCareers(this.$route.params.id, false)
        }).catch((error)=>{
          console.log(error);
        })
      }else{
        employeeCarreer.update_CadryCareers({id, data}).then((res)=>{
          this.get_CadryCareers(this.$route.params.id, false)
        }).catch((error)=>{
          console.log(error);
        })
    ...
    deleteCareer(id){
      employeeCarreer.delete_CadryCareers({id}).then((res)=>{
        this.get_CadryCareers(this.$route.params.id, false)
        }).catch((error)=>{
          console.log(error);
        })
